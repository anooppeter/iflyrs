/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function () {
            ...
            try {
                ...
                throw (
                    (a.h[c] === b
                        ...
                        : "TypeError" == d.name
                        ? (u.log("Video.js: " + c + " unavailable on " + a.ia + " playback technology element.", d),
                          (a.h.aa = l))
                        : u.log(d),
                    d)
                );
    ...
    t.volume = function (a) {
        if (a !== b)
            return (
                (a = Math.max(0, Math.min(1, parseFloat(a)))), (this.v.volume = a), L(this, "setVolume", a), u.td(a), this
            );
        ...
        if (d && 0 < d.length)
            for (var e = 0, g = d.length; e < g; e++)
                if ((c = d[e]) && c.getAttribute)
                    c.player === b &&
                        ((a = c.getAttribute("data-setup")), a !== h && ((a = u.JSON.parse(a || "{}")), v(c, a)));
                else {
                    u.kb();
                    break;
                }
